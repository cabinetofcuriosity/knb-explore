...
Now we wanta to download all the data using their [API](https://github.com/DataONEorg/rdataone), with the help of an [XML tutorial](https://www.stat.berkeley.edu/~statcur/Workshop2/Presentations/XML.pdf)  
```{r, eval = FALSE}
# load the package
library(XML)
library(dataone)
...
Finally downloaded one and the approximate total size should be 450GB
