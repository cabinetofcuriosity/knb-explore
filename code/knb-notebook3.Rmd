...
Right now there is something wrong with the KNB website so that we can't directly 
https://search.dataone.org/view/doi:10.6085/AA/SHB001_021ADCP020R00_20010312.50.1
```{r}
...
```{r}
dat <- read.csv(file = "../data/d1.csv", sep = " ", header = TRUE)
```
